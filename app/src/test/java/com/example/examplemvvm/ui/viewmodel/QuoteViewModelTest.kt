...
class QuoteViewModelTest {
    ...
    @RelaxedMockK
    private lateinit var getRandomQuoteUseCase: GetRandomQuoteCase
    ...
    fun `when viewmodel is created at the first time, get all quotes and set the first value`() = runTest{
        //Given
        val quote = listOf(Quote("Holi", "Elliot"), Quote("Hola Mundo", "Elliot "))
